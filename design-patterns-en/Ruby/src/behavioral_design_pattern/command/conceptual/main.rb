...
#
# Intent: Turns request into stand-alone object that contains all info about request 
# Parameterize methods with different requests, delay/queue request's execution &
# support undoable operations.

# 
# put single field in base Button class that stores command object reference 
# on click make button execute command

...
# Symbols are immutable, reusable constants represented internally by integer value. 
...
# Hashes: Ruby's dictionary with key/value pairs.
...
# Use postfix-if notation If condition controls invocation of a single statement vs code block
...
# _____________________________________LOOPS  
...
# Other looping functions 'map', 'reduce', 'inject' 
...
upcased = %w[Watch these words get upcased].map(&:upcase)
puts upcased
...
#_________________________________Destructuring
...
ranked_competitors = %w[John Sally Dingus Moe Marcy]
...
#__________________________________________Classes
